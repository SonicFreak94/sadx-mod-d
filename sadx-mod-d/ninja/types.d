...
alias Sint8   = byte;         /*  signed 1 byte integer       */
...
alias Int            = int;
alias Angle          = Sint32;
alias NJS_MATRIX     = Float[16];
alias NJS_MATRIX_PTR = Float*;
alias NJS_FOG_TABLE  = Float[128];
...
alias NJS_SYS_ATTR = Sint8[NJD_SYS_ATTR_SIZE];
...
alias NJS_PLANE = NJS_LINE;
alias NJS_PVECTOR = NJS_LINE;
...
alias NJS_MKEY_A1 = NJS_MKEY_SI32;
...
alias NJS_LIGHT_CAL_PTR = NJS_LIGHT_CAL*;
...
alias NJS_LIGHT_ATTR_PTR = NJS_LIGHT_ATTR*;
 ...
 * NJS_SCLATTR
 */
alias NJS_SCLATTR = Uint32;     /* scroll attribute structure   */

/*
 * NJS_SCLMTRX
 */
alias NJS_SCLMTRX = Float[4];   /* scroll rotation matrix       */
